        ...
        <table class="form">
		 ...
		 <tr>
		  ...
		  <tr>
            ...
            <td><input type="text" name="payeer_sort_order" value="<?php echo $payeer_sort_order; ?>" size="1" /></td>
          </tr>
		  <tr>
			<td colspan=2><?php echo $entry_title_pay_settings; ?></td>
		  </tr>
		  <tr>
            <td><?php echo $entry_url; ?></td>
            <td><input type="text" name="payeer_url" value="<?php echo $payeer_url; ?>" /></td>
          </tr>
          <tr>
            <td><span class="required">*</span> <?php echo $entry_merchant; ?></td>
            <td><input type="text" name="payeer_merchant" value="<?php echo $payeer_merchant; ?>" />
          ...
          <tr>
            ...
            <td><input type="text" name="payeer_security" value="<?php echo $payeer_security; ?>" />
		  ...
		  <tr>
            <td><?php echo $entry_list_ip; ?></td>
            <td><input type="text" name="list_ip" value="<?php echo $list_ip; ?>" size="60"/></td>
          </tr>
		  <tr>
            <td><?php echo $entry_admin_email; ?></td>
            <td><input type="text" name="admin_email" value="<?php echo $admin_email; ?>" size="60"/></td>
          </tr>
        </table>
      </form>
    </div>
